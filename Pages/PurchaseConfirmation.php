...
<form class="modal-content" method="post" style="width:50%" action="PurchaseConfirmation.php" autocomplete="on">
    <div class="container">
        <h2>Thank you <?= $Fname ?>,for Purchasing Awesome Jewellery!</h2>
        <p>Your Jewelry is on your way.</p>
        <p><b>Shipped to:</b></p>
        <p><?= $Fname ?> <?= $Lname ?></p>
        <p><?= $Address1 ?></p>
        <p><?= $Address2 ?></p>
        ...
        <hr>
        <Button type="button" class="signupbtn" onClick="document.location.href='.php';"/>Return Home!</Button>
